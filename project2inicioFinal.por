		...
		escreva("Segue a lista de Kart disponiveis")
	     ...
	     { 		
			...
			para (j=0; j < 15; j ++)
			{
	          	se(u[j] == k)
	          	{ 			
					escreva("O kart selecionado foi: ", k, "\n")
	...
	//listar karts locados
     ...
     { 		
        	...
        	{ 		
	     	se(t[j] == mG)
	     	{			            			
				escreva("O kart mais locado foi: ", u[j], "\n")
	      		escreva("O valor diario de locacao do kart: ", d[j], "\n")
	      		escreva("O kart ja foi locado ", t[j], " vezes\n")			
	          }
		} 
     ...
     funcao atualizarDia(inteiro j, real lC, inteiro u[], inteiro q[], inteiro lK, inteiro mI)
     {
		...
		{	
			se(q[j] == 1)
			{
	          	...
	          	se (u[j] != 0)
	          	{	
	          		escreva(" E ai vamos pagar?? Segue os kart com aluguel pendente: ", lK, "\n")				
	          	}
			}		
		}		
          escreva("\nDia atualizado!\n")                                  	
	...
	funcao inicio() 
     {
	     ...
	     real armazena2[15], lucro = 0.0, lucroR = 0.0, Valorcir = 0.0, valorloc = 0.0, lucroC = 0.0, lucroT = 0.0, armazenaLucro = 0.0
    		...
    		escreva("!!!Bem vindo a AKARACA LOCACOES de Karts e circuitos!!!\n") 
